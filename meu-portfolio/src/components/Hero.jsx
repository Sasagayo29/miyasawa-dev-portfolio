...
export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-center bg-background text-gray-300 p-8 font-mono relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto w-full z-10">
        ...
        <div className="flex gap-4">
          <button className="px-6 py-3 bg-terminal-green/10 text-terminal-green border border-terminal-green/50 hover:bg-terminal-green/20 hover:shadow-[0_0_15px_rgba(34,197,94,0.3)] transition-all rounded transition-colors duration-300">
            Explorar Projetos
          </button>
          <button className="px-6 py-3 text-gray-300 border border-gray-700 hover:border-gray-500 hover:text-white transition-colors duration-300 rounded">
            Contato
          </button>
        </div>
      </div>
